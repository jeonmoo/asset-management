...
public class AssetController {
    ...
    @PostMapping("/{assetId}/repair")
    public String repairAsset(@PathVariable("assetId") Long assetId, RedirectAttributes redirectAttributes) {
        assetService.repairAsset(assetId);
